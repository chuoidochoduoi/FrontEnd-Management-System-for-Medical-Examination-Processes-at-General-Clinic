    ...
    return <ReceptionistLayout>
        <div className="cares-reception-screen">
            <div className="cares-reception-page-header">
                ...
                <button onClick={() => navigate(ROUTES.RECEPTIONIST_CREATE_TICKET)} className="cares-reception-primary"><FilePlus size={19} />Tạo phiếu khám</button>
            </div>

            <div className="cares-reception-filter-bar lg:!grid-cols-[minmax(260px,1fr)_220px_220px_auto]">
