...
export function validateRegister({ identifier, password, confirmPassword, fullName, dob }) {
    ...
    if (dob) {
        ...
        if (birthDate > today) return 'Ngày sinh không thể ở trong tương lai.';
        ...
        if (age > 150) return 'Tuổi không hợp lệ (lớn hơn 150 tuổi).';
    }
